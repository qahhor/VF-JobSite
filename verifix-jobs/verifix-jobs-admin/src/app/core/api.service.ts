...
export class AdminApiService {
  ...
  getModerationQueue(status = 'PENDING', page = 0): Observable<any> {
    return this.http.get(`${this.base}/admin/moderation`, { params: { status, page } });
  }
  approveModeration(id: string): Observable<any> { return this.http.put(`${this.base}/admin/moderation/${id}/approve`, {}); }
  rejectModeration(id: string, reason: string): Observable<any> { return this.http.put(`${this.base}/admin/moderation/${id}/reject`, { reason }); }
