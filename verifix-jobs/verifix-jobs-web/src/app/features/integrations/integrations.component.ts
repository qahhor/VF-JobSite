  ...
  template: `
    <div class="space-y-6">
      <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-800">Integratsiyalar</h1>
        @if (hub()) {
          <div class="flex items-center gap-2">
            <span class="text-sm text-gray-500">Daraja:</span>
      ...
      @if (hub()) {
        <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
          <div class="flex items-center justify-between mb-2">
            <span class="text-sm font-medium text-gray-700">Integratsiya darajasi</span>
          ...
          <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100 flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center gap-2">
                ...
                @if (item.connected) {
                  <span class="text-[10px] px-2 py-0.5 bg-green-50 text-green-600 rounded-full font-medium">Ulangan</span>
                } @else {
                  <span class="text-[10px] px-2 py-0.5 bg-gray-100 text-gray-400 rounded-full font-medium">Ulanmagan</span>
                }
              </div>
