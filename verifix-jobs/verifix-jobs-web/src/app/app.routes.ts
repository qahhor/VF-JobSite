...
export const appRoutes: Routes = [
  ...
  // Employer portal (authenticated)
  {
    ...
    children: [
      ...
      { path: 'profile', loadComponent: () => import('./features/employer-profile/employer-profile.component').then(m => m.EmployerProfileComponent) },
      ...
      { path: 'time-tracking', loadComponent: () => import('./features/time-tracking/time-tracking.component').then(m => m.TimeTrackingComponent) },
